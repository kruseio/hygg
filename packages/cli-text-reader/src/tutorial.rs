...
pub fn get_tutorial_text() -> Vec<String> {
  vec![
    ...
    "".to_string(),
    "Bookmarks (persistent per document):".to_string(),
    ...
    "q = quit".to_string(),
    "h = highlight/unhighlight selected text (persistent per document)"
      .to_string(),
    ...
    "3. Highlights persist per document (yellow background)".to_string(),
