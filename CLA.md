...
- **MIT** — the libraries and shared crates (`cli-justify`, `redirect-stderr`, `cli-image-to-ascii`, `hygg-shared`, `cli-epub-to-text`, `cli-pdf-to-text`);
- **AGPL-3.0-only** — the reader / TUI (`cli-text-reader`, `hygg`); and
